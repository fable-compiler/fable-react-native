...
module NavigatorStatic =
    ...
    // TODO: Placeholder, not sure where Navigator is coming from
    type Navigator =
        interface end

    type NavState =
        abstract routeStack: ResizeArray<Route> with get, set
        abstract idStack: float []with get, set
    ...
    and NavigationBarStatic =
        inherit React.ReactElementType<NavigationBarProperties>
    ...
    and BreadcrumbNavigationBarStatic =
        inherit React.ReactElementType<BreadcrumbNavigationBarProperties>
...
and [<Import("AppRegistry","react-native")>] AppRegistry() =
    ...
    static member registerComponent(appKey: string, getComponentFunc: (unit -> React.ReactElementType<obj>)): string = jsNative
...
and TransformsStyle =
    ...
    abstract transformMatrix: float []option with get, set
...
and TextStatic =
    inherit React.ReactElementType<TextProperties>
...
and TextInputStatic =
    ...
    inherit React.ReactElementType<TextInputProperties>
...
and ToolbarAndroidStatic =
    inherit React.ReactElementType<ToolbarAndroidProperties>
...
and ViewStatic =
    inherit NativeComponent
    inherit React.ReactElementType<ViewProperties>

and KeyboardAvoidingViewStatic =
    inherit React.ReactElementType<KeyboardAvoidingViewProps>
...
and WebViewStatic =
    inherit React.ReactElementType<WebViewProperties>
...
and SegmentedControlIOSStatic =
    inherit React.ReactElementType<SegmentedControlIOSProperties>
...
and NavigatorIOSStatic =
    ...
    inherit React.ReactElementType<NavigatorIOSProperties>
...
and ActivityIndicatorStatic =
    inherit React.ReactElementType<ActivityIndicatorProperties>
...
and ActivityIndicatorIOSStatic =
    inherit React.ReactElementType<ActivityIndicatorIOSProperties>
...
and DatePickerIOSStatic =
    inherit React.ReactElementType<DatePickerIOSProperties>
...
and DrawerLayoutAndroidStatic =
    inherit React.ReactElementType<DrawerLayoutAndroidProperties>
...
and PickerIOSItemStatic =
    inherit React.ReactElementType<PickerIOSItemProperties>
...
and PickerItemStatic =
    inherit React.ReactElementType<PickerItemProperties>
...
and PickerStatic =
    inherit React.ReactElementType<PickerProperties>
...
and PickerIOSStatic =
    inherit React.ReactElementType<PickerIOSProperties>
...
and ProgressBarAndroidStatic =
    inherit React.ReactElementType<ProgressBarAndroidProperties>
...
and ProgressViewIOSStatic =
    inherit React.ReactElementType<ProgressViewIOSProperties>
...
and RefreshControlStatic =
    inherit React.ReactElementType<RefreshControlProperties>
...
and SliderStatic =
    inherit React.ReactElementType<SliderProperties>
...
and ImageStatic =
    inherit React.ReactElementType<ImageProperties>
...
and ListViewStatic<'a> =
    inherit React.ReactElementType<ListViewProperties<'a>>
...
and FlatListStatic<'a> =
    inherit React.ReactElementType<FlatListProperties<'a>>
...
and SectionListStatic<'a> =
    inherit React.ReactElementType<SectionListProperties<'a>>
...
and MapViewStatic =
    inherit React.ReactElementType<MapViewProperties>
...
and ModalStatic =
    inherit React.ReactElementType<ModalProperties>
...
and TouchableWithoutFeedbackStatic =
    inherit React.ReactElementType<TouchableWithoutFeedbackProps>
...
and ButtonStatic =
    inherit React.ReactElementType<ButtonProperties>


and TouchableHighlightStatic =
    inherit React.ReactElementType<TouchableHighlightProperties>
...
and TouchableOpacityStatic =
    inherit React.ReactElementType<TouchableOpacityProperties>
...
and TouchableNativeFeedbackStatic =
    inherit React.ReactElementType<TouchableNativeFeedbackProperties>
...
and Route =
    abstract ``component``: React.ReactElementType<ViewProperties> option with get, set
    abstract id: string option with get, set
    abstract title: string option with get, set
...
and NavigatorProperties =
    ...
    abstract navigator: Navigator option with get, set
    abstract onDidFocus: obj option with get, set
    abstract onWillFocus: obj option with get, set
...
and NavigatorStatic =
    inherit React.ReactElementType<NavigatorProperties>
...
and StyleSheetStatic =
    inherit React.ReactElementType<StyleSheetProperties>
    abstract hairlineWidth: float with get, set
...
and ListViewDataSource<'a> =
    ...
    abstract getSectionLengths: unit -> float
...
and TabBarItemStatic =
    inherit React.ReactElementType<TabBarItemProperties>
...
and TabBarIOSStatic =
    inherit React.ReactElementType<TabBarIOSProperties>
...
and DeviceEventEmitterStatic =
    ...
    abstract removeListener: eventType: string * listener: obj -> unit
...
and ScrollViewPropertiesIOS =
    ...
    abstract stickyHeaderIndices: float []option with get, set
...
and ScrollViewStatic =
    inherit React.ReactElementType<ScrollViewProps>
    ...
    abstract scrollTo: ?y: obj * ?x: float * ?animated: bool -> unit
...
and SwipeableListViewStatic<'a> =
    inherit React.ReactElementType<SwipeableListViewProps<'a>>
...
and ActionSheetIOSStatic =
    ...
    abstract showShareActionSheetWithOptions: (ShareActionSheetIOSOptions -> (Exception -> unit) -> (bool -> string -> unit) -> unit) with get, set
...
and AdSupportIOSStatic =
    abstract getAdvertisingId: ((string -> unit) -> (Exception -> unit) -> unit) with get, set
    abstract getAdvertisingTrackingEnabled: ((bool -> unit) -> (Exception -> unit) -> unit) with get, set
...
and PushNotification =
    abstract getMessage: unit -> obj
    abstract getSound: unit -> string
    abstract getAlert: unit -> obj
...
and StatusBarStatic =
    inherit React.ReactElementType<StatusBarProperties>
...
and SwitchStatic =
    inherit React.ReactElementType<SwitchProperties>
...
and VibrationStatic =
    abstract vibrate: pattern: U2<float, float[]> * repeat: bool -> unit
...
and GeolocationStatic =
    abstract getCurrentPosition: geo_success: (GeolocationReturnType -> unit) * ?geo_error: (Exception -> unit) * ?geo_options: GetCurrentPositionOptions -> unit
    abstract watchPosition: success: (Geolocation -> unit) * ?error: (Exception -> unit) * ?options: WatchPositionOptions -> unit
...
and NavigationAnimatedViewStatic =
    inherit React.ReactElementType<NavigationAnimatedViewStaticProps>
...
and NavigationHeaderStatic =
    inherit React.ReactElementType<NavigationHeaderProps>
...
and NavigationCardStackStatic =
    inherit React.ReactElementType<NavigationCardStackProps>
...
and NavigationContainerStatic =
    inherit React.ReactElementType<NavigationContainerProps>
...
and NavigationRootContainerStatic =
    inherit React.ReactElementType<NavigationRootContainerProps>
...
type Globals =
    ...
    [<Import("*", "@react-native-community/toolbar-android")>] static member ToolbarAndroid with get(): ToolbarAndroidStatic = jsNative and set(v: ToolbarAndroidStatic): unit = jsNative
    ...
    [<Import("*", "@react-native-community/netinfo")>] static member NetInfo with get(): NetInfoStatic = jsNative and set(v: NetInfoStatic): unit = jsNative
    ...
    [<Import("createElement", "react-native")>] static member createElement(``type``: React.ReactElementType, props: 'P, [<ParamArray>] children: React.ReactElement[]): React.ReactElement = jsNative
    [<Import("requireNativeComponent", "react-native")>] static member requireNativeComponent(viewName: string, ?componentInterface: ComponentInterface<'P>, ?extraConfig: obj): React.ReactElementType<'P> = jsNative
